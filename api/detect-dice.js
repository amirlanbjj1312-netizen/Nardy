  ...
  const content = [
    {
      ...
      text: 'Это фотография части игрового стола нард (backgammon) сразу после броска. ' +
        ...
        'Используемые кубики — крупные, белого цвета. На гранях с 1 и 4 точками точки обычно красного цвета, ' +
        'на гранях с 2, 3, 5 и 6 точками — синего цвета. Используй цвет точек как дополнительную подсказку ' +
        '(если видишь красные точки — это грань с 1 или 4, дальше просто посчитай их количество), но в первую очередь ' +
        'полагайся на точное количество точек. ' +
        'Найди на фото ровно два игральных кубика (лежащие где угодно в кадре) ' +
